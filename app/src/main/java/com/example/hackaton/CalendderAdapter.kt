...
class CalendderAdapter(private val listener: (calendarDateModel: CalenderDateModel, position: Int) -> Unit):
    RecyclerView.Adapter<CalendderAdapter.CalendarViewHolder>(){

    private var list = ArrayList<CalenderDateModel>()
    ...
    fun setData(calendarList: ArrayList<CalenderDateModel>) {
        list.clear()
